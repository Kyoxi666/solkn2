                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" className="w-full bg-[#f7f7f5] border-0 rounded-2xl p-4 focus:ring-2 focus:ring-solkn-lime outline-none transition-all" placeholder="John Doe" />
                        </div>
                        <div>
                            <label className="block text-sm font-bold mb-2 ml-1">Email</label>
                            <input type="email" className="w-full bg-[#f7f7f5] border-0 rounded-2xl p-4 focus:ring-2 focus:ring-solkn-lime outline-none transition-all" placeholder="john@company.com" />
                        </div>
                    </div>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-bold mb-2 ml-1">Company</label>
                            <input type="text" className="w-full bg-[#f7f7f5] border-0 rounded-2xl p-4 focus:ring-2 focus:ring-solkn-lime outline-none transition-all" placeholder="Your Company Ltd" />
                        </div>
                        <div>
                            <label className="block text-sm font-bold mb-2 ml-1">Phone</label>
                            <input type="tel" className="w-full bg-[#f7f7f5] border-0 rounded-2xl p-4 focus:ring-2 focus:ring-solkn-lime outline-none transition-all" placeholder="+44 ..." />
                        </div>
                    </div>
                    <div>
                        <label className="block text-sm font-bold mb-2 ml-1">Service Interest</label>
                        <select className="w-full bg-[#f7f7f5] border-0 rounded-2xl p-4 focus:ring-2 focus:ring-solkn-lime outline-none transition-all appearance-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <textarea className="w-full bg-[#f7f7f5] border-0 rounded-2xl p-4 focus:ring-2 focus:ring-solkn-lime outline-none transition-all min-h-[150px]" placeholder="Tell us about your project..."></textarea>
                    </div>
