...
const ServiceDetail: React.FC<ServiceDetailProps> = ({ serviceId, onNavigate }) => {
  ...
  const approach = service.approach || {
    description: "Each one plays a unique role in identifying opportunities for value, and together, they guide the robust technologies we integrate into your business.",
    items: [
        { label: "Discovery", title: "Hypothesis-Driven Analysis", description: "We test specific business hypotheses to identify the most impactful technology interventions before any code is written." },
        { label: "Implementation", title: "Broad Capability Integration", description: "Deploying robust, scalable solutions that address multiple operational challenges simultaneously across your stack." },
        { label: "Optimization", title: "Unbiased, AI-Powered Growth", description: "Continuous monitoring and AI-driven insights to refine performance, security, and efficiency in real-time." }
    ]
  };

  const focus = service.strategicFocus || {
      suffix: "Future-Proofing",
      description: "We don't just fix today's problems. We architect solutions that serve as the foundation for your next decade of growth.",
      items: [
          { title: "Reliability Portfolio", description: "We build systems that are resilient by design, targeting 99.99% uptime and redundant failover capacities for critical business functions." },
          { title: "Security Pipeline", description: "Our security-first mindset ensures that every layer of your infrastructure includes proactive threat hunting and automated defense mechanisms." },
          { title: "Innovation Programs", description: "We strive to create a world where legacy tech is no longer synonymous with decline, but a modifiable risk factor we can transform into an asset." }
      ]
  };
