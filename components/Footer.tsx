                            ...
                            <div className="flex flex-col md:flex-row gap-12 md:gap-24">
                                <div>
                                    ...
                                    <ul className="space-y-4 text-white/80">
                                        ...
                                        <li><button onClick={() => onNavigate('CASE_STUDIES')} className="hover:text-white transition-colors text-left">Case Studies</button></li>
                                        <li><button onClick={() => onNavigate('COMPANY')} className="hover:text-white transition-colors text-left">Company</button></li>
